...
namespace Dotnet9WPFControls.Controls
{
    ...
    public class HintForGuideWindow : Control
    {
        ...
        public static readonly DependencyProperty GridMarginProperty =
            DependencyProperty.Register(nameof(GridMargin), typeof(Thickness), typeof(HintForGuideWindow),
                new PropertyMetadata(new Thickness(16, 26, 16, 16)));

        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(HintForGuideWindow),
                new PropertyMetadata(null));

        public static readonly DependencyProperty ContentProperty =
            DependencyProperty.Register(nameof(Content), typeof(string), typeof(HintForGuideWindow),
                new PropertyMetadata(null));

        public static readonly DependencyProperty ButtonContentProperty =
            DependencyProperty.Register(nameof(ButtonContent), typeof(string), typeof(HintForGuideWindow),
        ...
        static HintForGuideWindow()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(HintForGuideWindow),
                new FrameworkPropertyMetadata(typeof(HintForGuideWindow)));
        }

        public HintForGuideWindow(Window ownerWindow, Point point, FrameworkElement targetControl, GuideInfo guide)
        {
